...
$sql = "INSERT INTO contact_marathabiz (name, designation, company_name, email, mobile)
 VALUES ('$name', '$designation','$company_name', '$email', '$mobile')";
...
# FIX: Replace this email with recipient email
 ...
 if ($conn->query($sql) === TRUE){         
    ...
    $subject = "Marathi Chamber of Business and Industries (MCBI) | Contact Us";
    $message = "Marathi Chamber of Business and Industries (MCBI) | Contact Form<no-reply@marathichamber.com>:\n\nName: $name \nDesignation: $designation \nCompany Name: $company_name \nEmail: $email \nMobile: $mobile \nMessage: $message";
    $headers = "From: Marathi Chamber of Business and Industries (MCBI) | Contact Form <no-reply@marathichamber.com>" . "\r\n";
                    ...
                    <div class="col-lg-5 col-xl-6 wow fadeInLeft" data-wow-delay="0.1s">
                        ...
                        <div class="carousel_wrapper">
                            ...
                            <div class="mb-3 mt-3" style="text-align:center; margin-top:20px; padding-bottom: 30px;">
                                <span style="color: #fff;">Did not receive OTP? <a href="otp_verify.php?do=resend">Resend</a>
