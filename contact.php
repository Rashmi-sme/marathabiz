...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Contact Us | MARATHA INTERNATIONAL BUSINESS ASSOCIATION (MIBA)</title>
        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6 col-xl-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <h2 class="display-5 text-white mb-2" style="color:#000 !important;">Get in Touch</h2>
                    ...
                    <div class="col-lg-6 col-xl-6 wow fadeInRight" data-wow-delay="0.3s">
                        ...
                        <div class="rounded h-100">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.772329070258!2d72.8626539752064!3d19.117641282095523!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c83ac5fea713%3A0x4f02f9254eb49e3c!2sMARATHA%20INTERNATIONAL%20BUSINESS%20ASSOCIATION!5e0!3m2!1sen!2sin!4v1740209802646!5m2!1sen!2sin" class="rounded w-100" style="height: 520px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            
                        </div>
                    </div>

                    <h2 class="display-5 text-white mb-2" style="color:#000 !important; font-size: 35px; text-align: center; ">Contact For More Information</h2>

                    <div class="col-lg-4 col-xl-6 wow fadeInUp" data-wow-delay="0.5s">
                        
                         <div class="d-flex flex-column align-items-center text-center mb-4">
                                
                                
                            <p class="mb-0 text-white">Mr. Mahesh Salunkhe<br/>
                              Director - India International Trade Centre (IITC-INDIA)<br/>
                              Contact Detail: +91 –7506046755</p>
                   ...
                   <div class="col-lg-4 col-xl-6 wow fadeInUp" data-wow-delay="0.5s">
                         ...
                         <div class="d-flex flex-column align-items-center text-center mb-4">
                            ...
                            <p class="mb-0 text-white">Ms. Saakshi kulkarni<br/>
                            Director - Maharashtra Industry Development Association (MIDA)<br/>
                            Contact Detail: +91 – 98201 79494</p>
                                
                            </div>
                  </div>


                    <div class="col-lg-4 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="bg-transparent rounded">
                            <div class="d-flex flex-column align-items-center text-center mb-4">
                                <div class="bg-white d-flex align-items-center justify-content-center mb-3" style="width: 50px; height: 50px; border-radius: 50px;"><i class="fa fa-map-marker-alt fa-2x text-primary"></i></div>
                                <h4 class="text-dark">Addresses</h4>
                                <p class="mb-0 text-white">Samruddhi Venture Park, Office No. 1, 3rd Floor, SEEPZ - MIDC Central Road, Next to Akruti Centre,Andheri (E) <br/>Mumbai - 400 093.</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="d-flex flex-column align-items-center text-center mb-4">
                                <div class="bg-white d-flex align-items-center justify-content-center mb-3" style="width: 50px; height: 50px; border-radius: 50px;"><i class="fa fa-phone-alt fa-2x text-primary"></i></div>
                                <h4 class="text-dark">Mobile</h4>
                                <p class="mb-0 text-white">+ 91 - 22 - 6951 1111 </p>
                                
                            </div>
                    </div>
                    <div class="col-lg-4 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="d-flex flex-column align-items-center text-center">
                            <div class="bg-white d-flex align-items-center justify-content-center mb-3" style="width: 50px; height: 50px; border-radius: 50px;"><i class="fa fa-envelope-open fa-2x text-primary"></i></div>
                            <h4 class="text-dark">Email</h4>
                            <p class="mb-0 text-white"><a href="mailto:mibaindia@gmail.com" style="color:#fff"> mibaindia@gmail.com</a></p>
