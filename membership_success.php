        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6 col-xl-3 wow fadeInLeft" data-wow-delay="0.1s">
                    </div>
                    <div class="col-lg-6 col-xl-6 wow fadeInLeft" data-wow-delay="0.1s">
                        
                        <div class="container_12 car" style="padding-top: 0px;">
            
                            <h3 style="text-align:center; font-size: 3rem;"><span><font color="#b12923" >Successfully Sent</font></span></h3>
                    
                            <div class="carousel_wrapper">
                               <p style="text-align:center; color: #fff; font-size: 20px;">
                               Thank you for showing interest in MARATHA INTERNATIONAL BUSINESS ASSOCIATION (MIBA).<br/>
                               If you have any query or looking for more information,<br/> please contact on :
                               <a href="mailto:mibaindia@gmail.com" style="color: #fff;">mibaindia[at]gmail[dot]com</a>
                               </p>
